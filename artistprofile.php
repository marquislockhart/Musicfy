...
if( (int)$id == $id && (int)$id > 0 ) {
    $link = mysqli_connect('localhost','root','','musicfy');
        ...
        <div class='artist__header'>
          <div class='artist__info'>
            ...
            <div class='profile__img'>
              <img src='imageView.php?id=".$row['id']."' alt='G-Eazy' />
            </div>

            <div class='artist__info__meta'>
              <div class='artist__info__type'>Artist</div>
              <div class='artist__info__name'>".$row['name']."</div>
                      ...
                      <div class='tracks'>
                        ...
                        <div class='track'>
                          ...
                          <div class='track__title featured'>
                            ...
                            <span class='feature'>Too Short</span>
                          </div>
