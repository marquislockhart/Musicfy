...
<head>
  ...
  <link rel="stylesheet" href="css/song_catalog.css">
</head>
      ...
      <div class="artist__header">
        <div class="artist__info">
          <div class="artist__info__meta">
            <div class="artist__info__name">Song Catalog</div>
          </div>
        </div>
      </div>
                ...
                <div class='album'>
                  <div class='album__tracks'>
                    <div class='tracks'>
                      ...
                      <?php
                      $sql = "SELECT artists.id, artists.name AS artist, albums.id, albums.name AS album, albums.genre AS genre, songs.name, songs.run_time, songs.explicit, songs.filename
                      FROM songs
