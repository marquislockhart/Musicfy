...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li class="active"><a href="song_catalog.php">Songs</a></li>
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" name="search_text" id="search_text" placeholder="Search for a song" class="form-control" />
    </div>
  </div><br/>
    <div id="result"></div>
  </div>
...
<table class="table table-striped table-bordered">
  <thead>
    <tr>
      ...
      <th style='width:150px;'>
        <a href="album_catalog.php">Album</a>
      </th>
      <th style='width:150px;'>Genre</th>
      <th style='width:150px;'>Run Time</th>
      <th style='width:150px;'>Explicit</th>
    </tr>
  </thead>
  <tbody>
    <?php
...
// -- code for pagination --
    ...
    "SELECT artists.id, artists.name AS artist, albums.id, albums.name AS album, albums.genre AS genre, songs.name, songs.run_time, songs.explicit
    FROM songs
